...
# database = str(arg[3])
# fold_path = str(arg[4])
name = 'LSTM_pamap2_model.pt'
modelfile = 'F:\lunwen\树莓派\HAR1\MSAP_PAMAP2\LSTM_pamap2_model.pt'
database = 'PAMAP2'
fold_path = 'F:\lunwen\树莓派\HAR1\MSAP_PAMAP2'+'\\'

datapath = 'F:\\lunwen\\HAR\\dataset\\'+database+'\\'
...
with torch.no_grad():     
    ...
    single_prediction = model(X[0].unsqueeze(0)).argmax(dim=1).cpu()
